        ...
        case 'notification':
          ...
          if (data.notification) {
            ...
            if (data.chatId || data.chat_id) {
              ...
              if (notificationType === 'user_left' || notificationType === 'group_deleted' || notificationType === 'user_removed') {
              ...
              if (notificationType === 'user_joined' || notificationType === 'group_created' || notificationType === 'user_left' || notificationType === 'group_deleted' || notificationType === 'user_removed') {
                const refreshEvent = new CustomEvent('refreshChats');
                window.dispatchEvent(refreshEvent);
              }
            }
